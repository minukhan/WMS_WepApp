...
@Slf4j
public class WebViewLoginService implements WebViewLoginUseCase {
    ...
    public Oauth2UserTokenResponse getToken(String authorizationCode) {
        ...
        KeycloakTokenDto keycloakTokenDto = keycloakAuthPort.exchangeWebViewCodeForToken(authorizationCode);
