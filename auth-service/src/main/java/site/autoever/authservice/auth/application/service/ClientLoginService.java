...
@Slf4j
public class ClientLoginService implements ClientLoginUseCase {
    ...
    public Oauth2UserTokenResponse getToken(String authorizationCode) {
        ...
        KeycloakTokenDto keycloakTokenDto = keycloakAuthPort.exchangeClientCodeForToken(authorizationCode);
