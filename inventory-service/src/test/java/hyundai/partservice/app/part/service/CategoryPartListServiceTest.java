...
import hyundai.partservice.app.part.adapter.out.CategoryPartListAdapter;
import hyundai.partservice.app.part.application.entity.Part;
import hyundai.partservice.app.part.application.port.out.CategoryPartListPort;
import hyundai.partservice.app.part.application.service.CategoryPartListService;
...
public class CategoryPartListServiceTest {

    @Mock
    private CategoryPartListPort categoryPartListPort;

    @InjectMocks
    private CategoryPartListService categoryPartListService;
    ...
    void getPartList() {
        ...
        String category = "엔진 부품";
        when(categoryPartListPort.getCategoryPartList(category, pageable)).thenReturn(partPage);
        //When

        PartListPaginationResponse response = categoryPartListService.getPartList(category, pageable);
